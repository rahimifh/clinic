...
class Searchbox (forms.Form):
    searchtxt=forms.CharField (max_length=100, widget=forms.TextInput(attrs={'class':'search-input', 'placeholder':"جستجوي پرونده" }))
...
class Filter_form(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['from_date'] = JalaliDateField(label=('از تریخ  '), # date format is  "yyyy-mm-dd"
            widget=AdminJalaliDateWidget
           # optional, to use default datepicker
        )
